          ...
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            ...
            <div className="text-center">
              <p className="text-xs font-semibold text-muted-foreground tracking-wide uppercase mb-3">
                Offering best exchange rates in the market
              </p>
                ...
                <Avatar className="bg-gray-200 h-8 w-8 ">
                 ...
                 {/*    <AvatarFallback>Women</AvatarFallback> */}
                  ...
                  <span className="z-10 inline-flex items-center justify-center h-8 w-8 rounded-full ring-2 ring-muted-foreground bg-background">
                    <span className="text-xs font-medium leading-none text-gray-800 uppercase">
                      10k+
                    </span>
                  </span>
                </div>
            ...
            {/* Form */}
            <form>
              <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 border rounded-xl shadow-xl shadow-primary-foreground ">
                <div className="pb-2 sm:pb-0 sm:flex-[1_0_0%]">
                  <Label htmlFor="name">
                    <span className="border rounded-xl sr-only">Your name</span>
                  </Label>
                  <Input className="border rounded-full" type="text" id="name" placeholder="Your name" />
                </div>
                <div className="pt-2 sm:pt-0 sm:ps-3 border-t sm:border-t-0 sm:border-s sm:flex-[1_0_0%]">
                  ...
                  <Input className="border rounded-full" type="email" id="email" placeholder="Your email" />
                </div>
